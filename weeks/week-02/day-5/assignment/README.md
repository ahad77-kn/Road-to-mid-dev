...
- [x] Page skeleton in Grid (`grid-template-areas`)
- [x] Top bar and video-card internals in Flexbox
- [x] `day-5/decisions.md`: for each of the 4 main regions, one line — "Grid because…" / "Flex because…"
- [x] Video grid uses `repeat(auto-fill, minmax(280px, 1fr))` — no media queries yet
- [x] Sidebar scrolls independently of the main area (`overflow-y: auto` + fixed height)
- [x] At least 12 video cards
