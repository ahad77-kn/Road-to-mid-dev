# 🛠️ Assignment — Week 05 Day 2 · 2 hours
...
| File | What it is |
| --- | --- |
| `methods.js` | all 10 rewritten + 5 harder ones, no `for` loop anywhere |
| `comparison.md` | 3 drills shown loop vs method, and which reads better |
