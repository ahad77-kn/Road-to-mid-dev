...
◀ [Day 2](../day-2/) · [⬆ Week 23 — Capstone: Build the Frontend, Connect Everything](../README.md) · [Day 4](../day-4/) ▶
...
The next two Must-have features, to the same standard.
